<template>
  <section class="relative w-full" data-aos="zom-in-up">
      ...
      <div class=" grid lg:grid-cols-2 gap-10 xl:gap-14 relative pt-24 lg:max-w-none max-w-2xl md:max-w-3xl mx-auto">
        <div class="lg: py-6">
          <div class="text-center lg:text-left ">
            <h1 class="pt-4 text-white lg:text-red-700 xl:text-blue-700 font-bold text-4xl md:text-5xl lg:text-6xl">
        ...
        <div class="lg:h-full md:flex">
          <div class="flex flex-row justify-center items-center w-full h-96 min-h-[24rem] lg:min-h-[none] lg:w-full lg:h-full md:w-5/6 relative">
            <div class="absolute z-0 top-1/2 -translate-y-1/2 w-full right-0 h-[calc(80%+20px)] bg-gradient-to-tr opacity-25 from-[#570cac] to-primary blur-2xl"></div>
            <div class="absolute h-full w-5/6 z-10 p-2 -translate-y-1/2 top-1/2 lg:right-3 md:right-0 sm:justify-center rounded-full shadow-lg border border-primary">
              <img src="/resume.jpg" alt="Hero pic" width="500" height="auto" loading="lazy"
