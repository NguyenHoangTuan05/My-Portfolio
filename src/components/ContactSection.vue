  ...
  <section class="text-white mt-20" id="contact">
    ...
    <div class="grid md:grid-cols-2 gap-4 relative px-4 xl:px-16 mt-8" data-aos="zoom-in-up">
      <div>
        <p class="text-[#adb7be]">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
          Animi ipsa minus obcaecati ratione voluptatem.
          Accusantium alias cumque eos in itaque quaerat voluptas?
          Atque culpa fuga officia placeat, quae reprehenderit temporibus.</p>
    ...
    overflow: hidden;border: 1px solid #111a3e;backdrop-filter: blur(9px);-webkit-backdrop-filter: blur(9px);">
        <form class="flex flex-col p-2" data-aos="zoom-in-up">
          ...
          <button class="z-1 w-[100%!important] px-6 md:px-7 py-2.5 rounded-full sm:w-max flex justify-center text-white bg-primary border-2 border-transparent">
            Send Message
          </button>
        </form>
      </div>
