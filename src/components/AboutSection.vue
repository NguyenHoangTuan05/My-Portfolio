  ...
  <section class="text-white mt-18" id="about">
    ...
    <div class="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16 z-1">
      <div data-aos="flip-right">
        <h2 class="text-3xl font-bold text-white text-left mb-8">My Education</h2>
      ...
      <div class="mt-4 md:mt-0 text-left flex flex-col z-10 h-full" data-aos="flip-right">
        <h2 class="text-4xl font-bold text-white md:text-center text-left mb-4">More
          <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">About</span> Me
        </h2>
        <p class="text-base lg:text-lg mt-8 py-8"> Lorem ipsum dolor sit amet, consectetur adipisicing elit.
          Aliquam cum deserunt eum ex explicabo, hic in ipsam libero minus officia omnis, perspiciatis placeat ratione repellendus totam voluptate voluptatibus.
          Debitis delectus placeat quibusdam recusandae voluptatum?
          Alias ea ipsa nesciunt officiis vitae?
          Delectus esse est exercitationem inventore ipsum minus necessitatibus quasi, quidem!
        </p>
